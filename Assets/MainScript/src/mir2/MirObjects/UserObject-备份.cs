...
//namespace Mir2
//{
//    public class UserObject : MapObject
//    {
...
//            this.InputDelay = Time.time + 0.4f;

//            if (Dead) return;

//            //ClearMagic();
//            RequestAction = null;
//            for (int i = ActionFeed.Count - 1; i >= 0; i--)
//            {
//                if (ActionFeed[i].Action == MirAction.Pushed) continue;
//                ActionFeed.RemoveAt(i);
//            }
