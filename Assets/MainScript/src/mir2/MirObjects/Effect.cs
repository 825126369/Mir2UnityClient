...
namespace Mir2
{
    public class Effect:MonoBehaviour
    {
        ...
        public Vector3Int DrawLocation;
        public Vector3Int DrawOffset = Vector3Int.zero;
        public bool Repeat;
        ...
        public Effect(string library, int baseIndex, int count, int duration, MapObject owner, long starttime = 0, bool drawBehind = false)
        {
            Library = library;
            BaseIndex = baseIndex;
        ...
        public Effect(string library, int baseIndex, int count, int duration, Vector3Int source, long starttime = 0, bool drawBehind = false)
        {
            Library = library;
            BaseIndex = baseIndex;
            Count = count == 0 ? 1 : count;
    ...
    public class Missile : Effect
    {
        ...
        public Missile(string library, int baseIndex, int count, int duration, MapObject owner, Vector3Int target, bool direction16 = true)
        ...
        public override void Process()
        {
            ...
            else if (!Explode)
            {
                ...
                if (dist < Globals.DataRange)
                    Destination += new Vector3Int(Destination.x - Source.x, Destination.y - Source.y);
            }
    ...
    public class InterruptionEffect : Effect
    {
        ...
        public InterruptionEffect(string library, int baseIndex, int count, int duration, MapObject owner, bool blend, long starttime = 0)
            : base(library, baseIndex, count, duration, owner)
        {
            Repeat = true;
            Blend = blend;
    ...
    public class ElementsEffect : Effect
    {
        ...
        public ElementsEffect(string library, int baseIndex, int count, int duration, MapObject owner, bool blend, int elementType, int killtime, bool loopon = false)
            : base(library, baseIndex, count, duration, owner)
        {
            Repeat = true;
            Blend = blend;
        ...
        {
            AudioMgr.Instance.PlaySound(20000 + 126 * 10 + 4 + myType, loopit);
        }
        ...
        private void StopSounds()
        {
            for (int i = 0; i <= 3; i++)
            {
                AudioMgr.Instance.StopSound(20000 + 126 * 10 + 5 + i);
            }
        }

        public override void Remove()
        {
            AudioMgr.Instance.StopSound(20000 + 126 * 10 + 4 + myType);
            base.Remove();
        }
    ...
    public class DelayedExplosionEffect : Effect
    {
        ...
        public DelayedExplosionEffect(string library, int baseIndex, int count, int duration, MapObject owner, bool blend, int Stage, long until)
            : base(library, baseIndex, count, duration, owner)
        {
            ...
            effectlist.Add(this);
            if (stage == 1)
                AudioMgr.Instance.PlaySound(20000 + 125 * 10);
            if (stage == 2)
                AudioMgr.Instance.PlaySound(20000 + 125 * 10 + 5);
        }
    ...
    public class SpecialEffect : Effect
    {
        ...
        public SpecialEffect(string library, int baseIndex, int count, int duration, MapObject owner, bool blend, bool drawBehind, uint type)
    ...
    public class BuffEffect : Effect
    {
        ...
        public BuffEffect(string library, int baseIndex, int count, int duration, MapObject owner, bool blend, BuffType buffType)
    ...
    public class LightEffect : Effect
    {
        ...
        public LightEffect(int duration, Vector3Int source, long starttime = 0, int lightDistance = 6, Color? lightColour = null)
