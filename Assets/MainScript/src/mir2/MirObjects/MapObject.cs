...
namespace Mir2
{
    public abstract class MapObject
    {
        ...
        public Vector3Int CurrentLocation, MapLocation;
        ...
        public string BodyLibrary;
        public Color DrawColour = Color.white, NameColour = Color.white, LightColour = Color.white;
        public Text NameLabel, ChatLabel, GuildLabel;
        public long ChatTime;
        public int DrawFrame, DrawWingFrame;
        public Vector3Int DrawLocation, Movement, FinalDrawLocation, OffSetMove;
        ...
        public static List<Text> DamageLabelList = new List<Text>();
        public List<Damage> Damages = new List<Damage>();

        protected Vector3Int GlobalDisplayLocationOffset
        {
            get { return new Vector3Int(0, 0); }
        }
        ...
        public abstract bool MouseOver(Vector3Int p);
        ...
        public void AddBuffEffect(BuffType type)
        {
            ...
            {
                case BuffType.Fury:
                    Effects.Add(new BuffEffect(Mir2Res.Magic3, 190, 7, 1400, this, true, type) { Repeat = true });
                    break;
                case BuffType.ImmortalSkin:
                    Effects.Add(new BuffEffect(Mir2Res.Magic3, 570, 5, 1400, this, true, type) { Repeat = true });
                    break;
                ...
                case BuffType.VampireShot:
                    Effects.Add(new BuffEffect(Mir2Res.Magic3, 2110, 6, 1400, this, true, type) { Repeat = false });
                    break;
                case BuffType.PoisonShot:
                    Effects.Add(new BuffEffect(Mir2Res.Magic3, 2310, 7, 1400, this, true, type) { Repeat = false });
                    break;
                case BuffType.EnergyShield:
                    BuffEffect effect;

                    Effects.Add(effect = new BuffEffect(Mir2Res.Magic2, 1880, 9, 900, this, true, type) { Repeat = false });
                    AudioMgr.Instance.PlaySound(20000 + (ushort)Spell.EnergyShield * 10 + 0);

                    effect.Complete += (o, e) =>
                    {
                        Effects.Add(new BuffEffect(Mir2Res.Magic2, 1900, 2, 800, this, true, type) { Repeat = true });
                    };
                    break;
                case BuffType.MagicBooster:
                    Effects.Add(new BuffEffect(Mir2Res.Magic3, 90, 6, 1200, this, true, type) { Repeat = true });
                    break;
                case BuffType.PetEnhancer:
                    Effects.Add(new BuffEffect(Mir2Res.Magic3, 230, 6, 1200, this, true, type) { Repeat = true });
                    break;
                case BuffType.GameMaster:
                    Effects.Add(new BuffEffect(Mir2Res.CHumEffect[5], 0, 1, 1200, this, true, type) { Repeat = true });
                    break;
                case BuffType.GeneralMeowMeowShield:
                    Effects.Add(new BuffEffect(Mir2Res.Monsters[(ushort)Monster.GeneralMeowMeow], 529, 7, 700, this, true, type) { Repeat = true, Light = 1 });
                    AudioMgr.Instance.PlaySound(8322);
                    break;
                case BuffType.PowerBeadBuff:
                    Effects.Add(new BuffEffect(Mir2Res.Monsters[(ushort)Monster.PowerUpBead], 64, 6, 600, this, true, type) { Blend = true, Repeat = true });
                    break;
                case BuffType.HornedArcherBuff:
                    Effects.Add(effect = new BuffEffect(Mir2Res.Monsters[(ushort)Monster.HornedArcher], 468, 6, 600, this, true, type) { Repeat = false });
                    effect.Complete += (o, e) =>
                    {
                        Effects.Add(new BuffEffect(Mir2Res.Monsters[(ushort)Monster.HornedArcher], 474, 3, 1000, this, true, type) { Blend = true, Repeat = true });
                    };
                    break;
                case BuffType.ColdArcherBuff:
                    Effects.Add(effect = new BuffEffect(Mir2Res.Monsters[(ushort)Monster.HornedArcher], 477, 7, 700, this, true, type) { Repeat = false });
                    effect.Complete += (o, e) =>
                    {
                        Effects.Add(new BuffEffect(Mir2Res.Monsters[(ushort)Monster.HornedArcher], 484, 3, 1000, this, true, type) { Blend = true, Repeat = true });
                    };
                    break;
                case BuffType.HornedWarriorShield:
                    Effects.Add(new BuffEffect(Mir2Res.Monsters[(ushort)Monster.HornedWarrior], 912, 18, 1800, this, true, type) { Repeat = true });
                    break;
                case BuffType.HornedCommanderShield:
                    Effects.Add(effect = new BuffEffect(Mir2Res.Monsters[(ushort)Monster.HornedCommander], 1173, 1, 100, this, true, type) { Repeat = false, Light = 1 });
                    effect.Complete += (o, e) =>
                    {
                        Effects.Add(new BuffEffect(Mir2Res.Monsters[(ushort)Monster.HornedCommander], 1174, 16, 1600, this, true, type) { Repeat = true, Light = 1 });
                    };
                    break;
            }
        }
        ...
        public virtual void CreateLabel()
        {
            ...
            //{
            //    if (LabelList[i].text != Name || LabelList[i].color != NameColour) continue;
        ...
        public virtual void DrawName()
        {
            ...
            NameLabel.text = Name;
            NameLabel.transform.localPosition = new Vector3(DisplayRectangle.x + (50 - NameLabel.rectTransform.sizeDelta.x) / 2, DisplayRectangle.y - (32 - NameLabel.rectTransform.sizeDelta.y / 2) + (Dead ? 35 : 8)); //was 48 -
        }
