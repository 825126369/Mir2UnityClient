...
namespace Mir2
{
    public class InIReader
    {
        ...
        public Vector3Int ReadPoint(string section, string key, Vector3Int Default)
        {
            ...
            return new Vector3Int(tempX, tempY);
        }

        public Vector2Int ReadSize(string section, string key, Vector2Int Default)
        {
            string temp = FindValue(section, key);
            int tempX, tempY;
        ...
        public void Write(string section, string key, Vector3Int value)
        {
            _contents[FindIndex(section, key)] = key + "=" + value.x + "," + value.y;
            Save();
        }

        public void Write(string section, string key, Vector2Int value)
        {
            _contents[FindIndex(section, key)] = key + "=" + value.x + "," + value.y;
            Save();
        }
